...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="wrapper">
            <header>
                <section id="top-area">
                    <p>Phone orders:  | Email us: <a href="bdbreker.byethost31.com">bdbreker.byethost31.com</a></p>
            ...
            <footer>
                <section id="contact">
                    <h3>PFor phone orders please call . You<br>can also email us at <a href="bdbreker.byethost31.com">bdbreker.byethost31.com</a></h3>
                </section><!-- end contact -->
                ...
                <section class="clearfix">
                    <div id="copyright">
                        ...
                        <p id="store-copy">&copy; 2016 eCommerce. Designed by Jahid Mahmud.</p>
                    </div><!-- end copyright -->
                    <div id="connect">
